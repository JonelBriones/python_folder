...
def dashboard():
    ...
    return render_template("login.html", user=User.get_one(data), recipes=Recipe.get_all(data))
...
@app.route('/update/<int:recipe_id>')
def update(recipe_id):
    data = {
        "id": recipe_id
    }
    return render_template('update.html', recipe=Recipe.get_recipe(data))
